...
BEGIN
  ...
  -- Start data for cinema_preferences
  DECLARE
      user_id UUID;
  BEGIN
      user_id := 'e9fc7e46-a8a5-4fd4-8ba7-af485013e6fa';

      INSERT INTO cinema_preferences (user_id, title, year, type, genre, status, created_at, updated_at) VALUES
      (user_id, 'Inception', 2010, 'movie', ARRAY['Action', 'Sci-Fi', 'Thriller'], 'liked', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (user_id, 'Interstellar', 2014, 'movie', ARRAY['Adventure', 'Drama', 'Sci-Fi'], 'liked', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (user_id, 'Game of Thrones', 2011, 'series', ARRAY['Action', 'Adventure', 'Drama'], 'liked', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (user_id, 'Titanic', 1997, 'movie', ARRAY['Drama', 'Romance'], 'disliked', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (user_id, 'The Notebook', 2004, 'movie', ARRAY['Drama', 'Romance'], 'disliked', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
  END;
